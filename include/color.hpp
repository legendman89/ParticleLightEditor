...
namespace ParticleLightEditor::Menu::Color {
    ...
    inline constexpr GUI::ImVec4 kEditorBackground{ 0.08F, 0.10F, 0.12F, 0.98F };
    ...
    inline constexpr GUI::ImVec4 kEditActionBackground{ 0.20F, 0.16F, 0.10F, 0.96F };
    inline constexpr GUI::ImVec4 kEditActionHover{ 0.38F, 0.29F, 0.15F, 1.00F };
